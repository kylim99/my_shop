...
import com.example.demo.repository.ProductFolderRepository;
...
public class ProductService {
    ...
    public void addFolder(Long productId, Long folderId, User user) throws IllegalAccessException {
        ...
        if(!product.getUser().getId().equals(user.getId())
            ...
            throw new IllegalAccessException("회원의 관심 상품이 아니거나 회원의 폴더가 아닙니다");

        }
        Optional<ProductFolder> overlapFolder =  productFolderRepository.findByProductAndFolder(product,folder);

        if (overlapFolder.isPresent()){
            throw new IllegalAccessException("중복된 폴더 입니다" +
                    "");
        }
